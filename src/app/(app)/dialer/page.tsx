        ...
        <div className="flex gap-2">
          {!active ? (
            <form action={startCallSession}>
              <SubmitButton pendingLabel="Starting…" className="rounded-lg bg-emerald-600 text-white text-sm font-medium px-3 py-2 hover:bg-emerald-700">
                Start session
              </SubmitButton>
            </form>
          ) : (
            <>
              <form action={pauseCallSession}>
                <SubmitButton pendingLabel="…" className="rounded-lg bg-slate-100 text-slate-700 text-sm font-medium px-3 py-2 ring-1 ring-slate-200 hover:bg-slate-200">
                  {isPaused ? "Resume" : "Pause"}
                </SubmitButton>
              </form>
              <form action={endCallSession}>
                <SubmitButton pendingLabel="Ending…" className="rounded-lg ring-1 ring-slate-300 text-slate-700 text-sm font-medium px-3 py-2 hover:bg-slate-50">
                  End session
                </SubmitButton>
              </form>
            </>
