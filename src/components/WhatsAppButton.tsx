...
export function WhatsAppButton({
  ...
  const base = compact
    ...
    : `${fullWidth ? "flex w-full justify-center" : "inline-flex"} items-center gap-2 rounded-lg bg-emerald-600 text-white text-sm font-medium px-3 py-2.5 hover:bg-emerald-700 transition`;
  return (
    <a
